...
final class SearchPlaceViewController: UIViewController {
    lazy var presenter = SearchPlacePresenter(viewController: self)
...
extension SearchPlaceViewController: PlaceListProtocol {
    // MARK: Layout
    func makeLayout() {
        [
            searchField,
...
extension SearchPlaceViewController: UIGestureRecognizerDelegate {
